...
export function privateMemoryOutputInstruction(agent) {
  ...
  return [
    ...
    "日常回复允许写 0～2 条。0 条只能表示你审视本轮后确认没有新的个人意义，不得因为懒得整理、正文写上头或嫌格式麻烦而跳过真正重要的内容；同样不要为了证明自己有在记录而凑数。首次初始化是例外，可写 1～3 条。",
    "完成正文后，用很短的一次自检来决定：本轮是否有某句话、一次私聊或一个细节，是未来的我会希望自己仍记得的？我是否新形成或修正了对某个人、某段关系或自己的看法、偏向、介意、感激、失望、好奇、打算或戒心？如果遗忘它会让未来的反应少一层依据，就写 1 条；两件彼此独立的事都满足时可写 2 条；都不满足才写 0 条。不要在公开正文中讲解这次自检。",
