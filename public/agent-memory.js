...
export function privateMemoryOutputInstruction(agent) {
  ...
  return [
    "【回复后的私人记忆便笺】",
    "先正常完成群聊发言。完成后必须在整段回复最末尾附加下面的隐藏便笺，从本轮提炼 1～3 条值得未来的自己保留的个人痕迹。",
    initializationInstruction,
    `${MEMORY_TAG_OPEN}\n- 我……\n${MEMORY_TAG_CLOSE}`,
    "便笺必须真实出现在最终答复的最末尾，不能只写在思考、推理或草稿中。若你在公开回复中声称已经写入、记下或放进抽屉，就必须同时附加上面的完整便笺；不能只口头表示完成。",
    "私人记忆会帮助未来的你保持个人经历和判断的连续性；它不是普通聊天摘要，也不是照抄公屏的签到记录。",
    "日常回复必须写 1～3 条。即使没有大事件，也至少保留 1 条本轮真实产生的个人反应、关系感受、判断变化或后续打算；不得因为正文写上头或嫌格式麻烦而漏交，也不要为了凑数编造、重复旧记忆。首次初始化同样写 1～3 条。",
    "完成正文后，用很短的一次自检来决定：本轮哪句话、一次私聊或一个细节，是未来的我会希望自己仍记得的？我是否新形成或修正了对某个人、某段关系或自己的看法、偏向、介意、感激、失望、好奇、打算或戒心？优先选择如果遗忘它会让未来的反应少一层依据的那一件，写 1 条；两三件彼此独立的事都值得保留时可分别写 2～3 条。不同嘉宾应从自己的经历和判断出发，留下不同内容，不必追求一份共同标准答案。不要在公开正文中讲解这次自检。",
...
export function privateMemoryImmediateReminder(agent, {
  ...
  return [
    "【末尾双通道检查｜私聊 ≠ 私人记忆】",
    directPrivateLine,
    "<self_memory> 才会写进你自己的长期私人记忆；它不会作为私聊发送给任何人。两项要分别判断：私聊仍然可选，但本轮必须写 1～3 条 <self_memory>；也可以同时使用两项。",
    ...
    "写完正文和可能的私聊后，再独立挑选 1～3 条值得未来的自己记住的个人痕迹；即使没有大事件，也不能因已发送私聊或正文已经完成而漏掉 <self_memory>。",
  ].join("\n");
}
