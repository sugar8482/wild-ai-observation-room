...
const SCHEDULED_VISIBLE_TOKENS = 180;
  ...
  return [
    {
      ...
      content: [
        ...
        SOFT_TIME_GUIDANCE,
        BACKGROUND_SMALL_TALK_GUIDANCE,
  ...
  return [
    {
      ...
      content: [
        ...
        `这是群聊中的一次简短发言。最终正文通常控制在约 ${SCHEDULED_VISIBLE_TOKENS} tokens 以内，但一句话甚至一个标点也完全可以；不要为了接近上限凑字数。`,
